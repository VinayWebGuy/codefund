...
<div class="table container">
    <h4 class="row">Payment Links (Generated by me)
        <a href="{{url('main/user/funds/payment-link')}}" class="btn primary sm">Create new</a>
    </h4>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if($link->status == 0)
                    <button title="QR" class="btn primary sm showQr" data-link="{{url('main/user/funds/pay-via-link')}}/{{$link->link}}"><i class="fa fa-qrcode"></i></button>
                    @else
                    <button title="Expired" class="btn danger sm"><i class="fa fa-ban"></i></button>
                    @endif
                </td>
                <td>
                    @if($link->status == 1)
                        <button title="Paid" class="btn primary sm"><i class="fa fa-check"></i></button>
                    @else
                        <button title="Pending" class="btn warning sm"><i class="fa fa-clock"></i></button>
                    @endif
                </td>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    @if($link->status == 0)
                    <a href="{{url('main/user/funds/pay-via-link')}}/{{$link->link}}" title="Pay" class="btn primary sm"><i class="fa fa-credit-card"></i></a>
                    @else
                        <button title="Paid" class="btn warning sm"><i class="fa fa-check"></i></button>
                    @endif
                </td>
                <td>
                    @if($link->status == 0)
